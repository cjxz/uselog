...
public class JsonCharBuilderTest {

    @Test
    public void test() {
        JsonCharBuilder json = JsonCharBuilder.create()
            .beginObject()
    ...
    public void testNullObject() {
        JsonCharBuilder builder = JsonCharBuilder.create()
            .beginObject()
            .key("hi").value(null)
            .endObject();
    ...
    @Test
    public void testCJK() {
        String json = JsonCharBuilder.create()
            .beginObject()
    ...
    public void testToByteArray() {
        val json = JsonCharBuilder.create()
            .beginObject()
            .key("the中文key").value("enn.中文..value")
            .endObject();
